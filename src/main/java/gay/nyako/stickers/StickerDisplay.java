...
public class StickerDisplay {
    ...
    public Sticker stickerData = null;
    ...
    public void render(DrawContext drawContext)
    {
        ...
        drawContext.drawTexture(stickerData.identifier, (int) drawX + 1, (int) drawY + 1, 0, 0, width, height, width, height);
        drawContext.setShaderColor(1, 1, 1, 1);
        drawContext.drawTexture(stickerData.identifier, (int) drawX, (int) drawY, 0, 0, width, height, width, height);
